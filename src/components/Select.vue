<template>
  ...
  >
    ...
    <div class="relative">
      <Button
        type="button"
        class="w-full flex items-center justify-between bg-transparent text-slate-50 border border-solid border-slate-300"
        @click="showOptions = !showOptions"
      >
        <span class="truncate">{{ options[model] }}</span>
