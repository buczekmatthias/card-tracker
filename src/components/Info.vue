<template>
  <div class="grid grid-cols-[auto_1fr] gap-x-2 items-center italic">
    <svg class="h-5 fill-white/65" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <p class="font-light text-white/65" v-html="message"></p>
  </div>
</template>
